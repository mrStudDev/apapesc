    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recebe_seguro', models.CharField(blank=True, choices=[('Não Recebe', 'Não Recebe'), ('A partir de Dez', 'A partir de Dez'), ('A partir de Jan', 'A partir de Jan'), ('A partir de Fev', 'A partir de Fev'), ('A partir de Março', 'A partir de Março'), ('Não declarado', 'Não declarado')], default='Não declarado', max_length=50, null=True)),
                ...
                ('status', models.CharField(blank=True, choices=[('Associado Lista Ativo(a)', 'Associado Lista Ativo(a)'), ('Associado Lista Aposentado(a)', 'Associado  Lista Aposentado(a)'), ('Candidato(a)', 'Candidato(a)'), ('Cliente Especial', 'Cliente Especial'), ('Desassociado(a)', 'Desassociado(a)')], default='Candidato(a)', max_length=40, null=True, verbose_name='Status')),
                ('especie1', models.CharField(blank=True, choices=[('Abrótea', 'Abrótea'), ('Anchova', 'Anchova'), ('Atum', 'Atum'), ('Bagre', 'Bagre'), ('Baiacu', 'Baiacu'), ('Cação', 'Cação'), ('Cavala', 'Cavala'), ('Corvina', 'Corvina'), ('Garoupa', 'Garoupa'), ('Linguado', 'Linguado'), ('Marisco', 'Marisco'), ('Pampo', 'Pampo'), ('Pescada-olhuda', 'Pescada-olhuda'), ('Robalo', 'Robalo'), ('Sardinha', 'Sardinha'), ('Tainha', 'Tainha'), ('Xerelete', 'Xerelete'), ('Não declarado', 'Não declarado')], default='Não declarado', max_length=50, null=True, verbose_name='Espécie 1')),
                ('quantidade1', models.CharField(blank=True, max_length=12, null=True, verbose_name='Quantidade 1 (Kg)')),
                ('especie2', models.CharField(blank=True, choices=[('Abrótea', 'Abrótea'), ('Anchova', 'Anchova'), ('Atum', 'Atum'), ('Bagre', 'Bagre'), ('Baiacu', 'Baiacu'), ('Cação', 'Cação'), ('Cavala', 'Cavala'), ('Corvina', 'Corvina'), ('Garoupa', 'Garoupa'), ('Linguado', 'Linguado'), ('Marisco', 'Marisco'), ('Pampo', 'Pampo'), ('Pescada-olhuda', 'Pescada-olhuda'), ('Robalo', 'Robalo'), ('Sardinha', 'Sardinha'), ('Tainha', 'Tainha'), ('Xerelete', 'Xerelete'), ('Não declarado', 'Não declarado')], default='Não declarado', max_length=50, null=True, verbose_name='Espécie 2')),
                ('quantidade2', models.CharField(blank=True, max_length=12, null=True, verbose_name='Quantidade 2 (Kg)')),
                ('especie3', models.CharField(blank=True, choices=[('Abrótea', 'Abrótea'), ('Anchova', 'Anchova'), ('Atum', 'Atum'), ('Bagre', 'Bagre'), ('Baiacu', 'Baiacu'), ('Cação', 'Cação'), ('Cavala', 'Cavala'), ('Corvina', 'Corvina'), ('Garoupa', 'Garoupa'), ('Linguado', 'Linguado'), ('Marisco', 'Marisco'), ('Pampo', 'Pampo'), ('Pescada-olhuda', 'Pescada-olhuda'), ('Robalo', 'Robalo'), ('Sardinha', 'Sardinha'), ('Tainha', 'Tainha'), ('Xerelete', 'Xerelete'), ('Não declarado', 'Não declarado')], default='Não declarado', max_length=50, null=True, verbose_name='Espécie 3')),
                ('quantidade3', models.CharField(blank=True, max_length=12, null=True, verbose_name='Quantidade 3 (Kg)')),
                ('especie4', models.CharField(blank=True, choices=[('Abrótea', 'Abrótea'), ('Anchova', 'Anchova'), ('Atum', 'Atum'), ('Bagre', 'Bagre'), ('Baiacu', 'Baiacu'), ('Cação', 'Cação'), ('Cavala', 'Cavala'), ('Corvina', 'Corvina'), ('Garoupa', 'Garoupa'), ('Linguado', 'Linguado'), ('Marisco', 'Marisco'), ('Pampo', 'Pampo'), ('Pescada-olhuda', 'Pescada-olhuda'), ('Robalo', 'Robalo'), ('Sardinha', 'Sardinha'), ('Tainha', 'Tainha'), ('Xerelete', 'Xerelete'), ('Não declarado', 'Não declarado')], default='Não declarado', max_length=50, null=True, verbose_name='Espécie 4')),
                ('quantidade4', models.CharField(blank=True, max_length=12, null=True, verbose_name='Quantidade 4 (Kg)')),
                ('especie5', models.CharField(blank=True, choices=[('Abrótea', 'Abrótea'), ('Anchova', 'Anchova'), ('Atum', 'Atum'), ('Bagre', 'Bagre'), ('Baiacu', 'Baiacu'), ('Cação', 'Cação'), ('Cavala', 'Cavala'), ('Corvina', 'Corvina'), ('Garoupa', 'Garoupa'), ('Linguado', 'Linguado'), ('Marisco', 'Marisco'), ('Pampo', 'Pampo'), ('Pescada-olhuda', 'Pescada-olhuda'), ('Robalo', 'Robalo'), ('Sardinha', 'Sardinha'), ('Tainha', 'Tainha'), ('Xerelete', 'Xerelete'), ('Não declarado', 'Não declarado')], default='Não declarado', max_length=50, null=True, verbose_name='Espécie 5')),
