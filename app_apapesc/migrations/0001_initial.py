    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_apapesc.cargosmodel', verbose_name='Cargo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrador', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='administrador_apapesc', to='app_apapesc.integrantesmodel', verbose_name='Administrador')),
                ('diretores', models.ManyToManyField(blank=True, related_name='diretores_apapesc', to='app_apapesc.integrantesmodel', verbose_name='Diretores')),
                ('presidente', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='presidente_apapesc', to='app_apapesc.integrantesmodel', verbose_name='Presidente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_abertura', models.DateField(blank=True, null=True, verbose_name='Data de Abertura')),
                ('data_encerramento', models.DateField(blank=True, null=True, verbose_name='Data de Encerramento')),
                ('apapesc', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='reparticoes', to='app_apapesc.apapescmodel', verbose_name='Apapesc')),
                ('delegado', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='delegado_apapesc', to='app_apapesc.integrantesmodel', verbose_name='Delegado')),
                ('municipio_sede', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sedes', to='app_apapesc.municipiosmodel')),
                ('municipios_circunscricao', models.ManyToManyField(blank=True, default='', max_length=100, to='app_apapesc.municipiosmodel')),
            ],
        ),
        migrations.AddField(
            model_name='integrantesmodel',
            name='reparticao',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='integrantes', to='app_apapesc.reparticoesmodel', verbose_name='Repartição'),
        ),
    ]
