    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrador', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='administrador_associacao', to='app_associacao.integrantesmodel', verbose_name='Administrador')),
                ('diretores', models.ManyToManyField(blank=True, related_name='diretores_associacao', to='app_associacao.integrantesmodel', verbose_name='Diretores')),
                ('presidente', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='presidente_associacao', to='app_associacao.integrantesmodel', verbose_name='Presidente')),
            ],
            options={
